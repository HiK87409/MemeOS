...
exports.prepareVisualizerData = exports.visualizer = void 0;
...
const visualizer = async (metadata, opts = {}) => {
    ...
    const fileContent = await (0, render_template_1.renderTemplate)(template, {
        title,
        data: (0, exports.prepareVisualizerData)(metadata),
    });
    return fileContent;
};
...
const prepareVisualizerData = (metadata) => {
    const projectRoot = "";
    const roots = [];
...
exports.prepareVisualizerData = prepareVisualizerData;
